...
'''
This version uses localhost (and currently untested remote) ips
to actually emulate the network delay and failures.  Needs more revisions
to actually be a practical implementation of federated learning
'''
...
def load_cache(filename):
    if os.path.exists(CACHE_FOLDER + '/' + filename):
